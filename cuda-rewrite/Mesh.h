...
****************/
 ...
 __device__ int32_t ccs_VertexCount(const cc_Subd *subd);
 ...
 __device__ int32_t ccs_CumulativeHalfedgeCountAtDepth(const cc_Mesh *cage, int32_t depth);
 ...
 __device__ int32_t ccs_CumulativeCreaseCountAtDepth(const cc_Mesh *cage, int32_t depth);

// O(1) data-access
 __device__ int32_t ccs_HalfedgeTwinID(const cc_Subd *subd, int32_t halfedgeID, int32_t depth);
 __device__ int32_t ccs_HalfedgeNextID(const cc_Subd *subd, int32_t halfedgeID, int32_t depth);
 __device__ int32_t ccs_HalfedgePrevID(const cc_Subd *subd, int32_t halfedgeID, int32_t depth);
 __device__ int32_t ccs_HalfedgeFaceID(const cc_Subd *subd, int32_t halfedgeID, int32_t depth);
 __device__ int32_t ccs_HalfedgeEdgeID(const cc_Subd *subd, int32_t halfedgeID, int32_t depth);
 __device__ int32_t ccs_HalfedgeVertexID(const cc_Subd *subd, int32_t halfedgeID, int32_t depth);
...
#endif
 __device__ float ccs_HalfedgeSharpness   (const cc_Subd *subd, int32_t halfedgeID, int32_t depth);
...
// halfedge remapping (O(1))
 __device__ int32_t ccs_NextVertexHalfedgeID(const cc_Subd *subd, int32_t halfedgeID, int32_t depth);
 __device__ int32_t ccs_PrevVertexHalfedgeID(const cc_Subd *subd, int32_t halfedgeID, int32_t depth);

// (vertex, edge, face) -> halfedge mappings
 __device__ int32_t ccs_VertexToHalfedgeID(const cc_Subd *subd,
                                     int32_t vertexID,
                                     int32_t depth);
 __device__ int32_t ccs_EdgeToHalfedgeID(const cc_Subd *mesh,
                                   int32_t edgeID,
                                   int32_t depth);
 __device__ int32_t ccs_FaceToHalfedgeID(const cc_Subd *mesh,
                                   int32_t faceID,
                                   int32_t depth);
